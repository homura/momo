...
},{"./bundle-url":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"d3.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"demo.ts":[function(require,module,exports) {
"use strict";
...
function randomLetters() {
  return d3.shuffle('abcdefghijklmnopqrstuvwxyz'.split('')).slice(0, Math.floor(6 + Math.random() * 20)).sort();
}

var svg = d3.select('svg').attr('width', width).attr('height', 33).attr('viewBox', "0 -20 " + width + " 33");
svg.selectAll('text').data(randomLetters()).join('text').attr('x', function (d, i) {
  return i * 16;
}).text(function (d) {
  return d;
});
},{"d3":"node_modules/d3/index.js","./d3.css":"d3.css"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "2952" + '/');
